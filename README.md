...
# 03-01-lab-lista-noticias

Es peor utilizar el index como clave porque el index independientemente de que la lista cambie de orden seguirá siendo el mismo, por lo tanto se pueden refrescar incorrectamente los elementos.
Por ejemplo, el elemento 0 antes era la noticia 1, pero después del orden es la 2. El contenido es diferente pero las keys siguen siendo la misma, esto puede dar problemas
